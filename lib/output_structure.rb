...
class OutputStructure
  ...
  #   @folder = folder
  #   md_files = Dir.entries(@home + '/_output' + @folder).find_all do |filename|
  ...
  #
  # def convert(file)
  #   files_md = File.read(@home + '/_output' + @folder + file)
  #   html_content = Kramdown::Document.new(files_md).to_html
  ...
  #   convert_files('/pages/')
  #   convert_files('/posts/')
  #   convert_files('/') # for index.md index.html
  # end
